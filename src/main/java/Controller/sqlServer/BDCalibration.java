...
public class BDCalibration {
    ...
    public void saveCalibration(String code, String unit, String name) {
        try {
            conexion.setConexion();
    ...
    public void deleteCalibration(String code) {
        try {
            conexion.setConexion();
    ...
    public void saveOrUpdateCalibration(String code, String unit, String name) {
        try {
            conexion.setConexion();
            ...
            if (resultSet.next()) {
                ...
                updateCalibration(code, unit, name);
            } else {
                // El registro no existe, entonces crea un nuevo registro
                saveCalibration(code, unit, name);
            }
        } catch (SQLException error) {
            error.printStackTrace();
        }
    ...
    public void updateCalibration(String code, String unit, String name) {
        try {
            conexion.setConexion();
